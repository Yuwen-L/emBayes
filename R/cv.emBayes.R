...
#' The spike scale parameter \eqn{SL.s0} and the slab scale parameter \eqn{SL.s1} are obtained based on the squared loss. 
...
#' \item{SL.s0}{the optimal slab scale under squared loss.}
#' \item{SL.s1}{the optimal slab scale under squared loss.}
...
#' \item{SL.CV}{cross-validation error matrix under squared loss.}
